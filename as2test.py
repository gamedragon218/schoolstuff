...
def cEnc(pt, key):
	...
	for x in pt:
		...
		nIndex = index - key
		if nIndex > len(alphabet) - 1:
			nIndex = nIndex-len(alphabet)
		ct += alphabet[nIndex]
